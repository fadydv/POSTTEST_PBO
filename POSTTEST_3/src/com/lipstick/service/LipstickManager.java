...
public class LipstickManager {
    ...
    public void tampilkanLipstick() {
        ...
        for (Lipstick l : daftarLipstick) {
            System.out.println("ID Produk    : " + l.getId());
            System.out.println("Nama Produk  : " + l.getNamaProduk());
            ...
            if (l instanceof MatteLipstick) {
                ...
                System.out.println("Ketahanan    : " + ((MatteLipstick) l).getKetahananJam() + " Jam");
            } else if (l instanceof LipTint) {
                System.out.println("Jenis        : Lip Tint");
                System.out.println("Bahan Dasar  : " + ((LipTint) l).getBahanDasar());
            }
            System.out.println("---------------------------------");
        }
    }
    ...
    public void updateLipstick() {
        ...
        for (Lipstick l : daftarLipstick) {
            if (l.getId() == idCari) {
                ...
                l.setHarga(input.nextInt()); input.nextLine();
